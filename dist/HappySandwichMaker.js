  ...
  _createClass(HappySandwichMaker, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { style: { "display": "flex", flexDirection: "row", justifyContent: "center", width: "100%" }, __self: this
        },
        action == "next" ? _react2.default.createElement(
          "button",
          { style: _extends({}, style, { flex: "0 0 auto", backgroundColor: color }), onClick: this.next.bind(this), __self: this
          },
          text
        ) : _react2.default.createElement(
          "a",
          { style: _extends({}, style, { flex: "0 0 auto", backgroundColor: color }), href: href, __self: this
          },
          text
        )
      );
